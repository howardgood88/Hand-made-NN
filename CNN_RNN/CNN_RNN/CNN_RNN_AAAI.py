...
class Multitask_Neural_Network(Tf_Utility):
	...
	def run_multi_task_2(self, sess, task_name_1='', task_name_2='', optimizer='optomizer'):
		...
		# batch_x, batch_y = get_multi_task_batch(batch_x, batch_y)
		cost, L2 = run_task_optimizer(sess, batch_x_1, batch_y_1, batch_x_2, batch_y_2, task_name_1)
		task['training_temp_loss'] += cost
			...
			with tf.device('/gpu:0'):
				try:
					for epoch in range(self.iter_epoch):
						self.run_multi_task_2(sess, 'CDR_max_traffic', 'rain_traffic')
						self.run_multi_task_2(sess, 'CDR_avg_traffic', 'rain_traffic')
						self.run_multi_task_2(sess, 'CDR_min_traffic', 'rain_traffic')
...
class CNN_RNN_2_test(Multitask_Neural_Network):
	def __init__(self, input_data_shape, output_data_shape, input_data_shape_2, output_data_shape_2, config):
